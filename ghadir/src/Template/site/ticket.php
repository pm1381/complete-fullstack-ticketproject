...
<div class="container" id="hero">
    <div class="row justify-content-center pt-4">
        <div class="col-11 col-md-4">
            <div class="card" style="background-color:#C08801;">
                ...
                <div class="card-body">
                        ...
                        <div class="col-7">
                            <div class="row align-items-center h-100">
                                <div class="col-12 text-right">
                                    <span>نام :</span>
                                    <span class=""><?php echo $this->data["userResult"]["userName"] ?></span>
                                </div>
                                <div class="col-12 text-right">
                                    <span style="font-size:0.8rem">شماره همراه :</span>
                                    <span style="font-size:0.8rem"><?php echo $this->data["userResult"]["userMobile"] ?></span>
                                </div>
                                <div class="col-12 text-right">
                                    <span>کد رزرو :</span>
                                    <span class=""><?php echo $this->data["userResult"]["userCode"] ?></span>
                                </div>
                                <div class="col-12 text-right">
                                    <span>تعداد نفرات :</span>
                                    <span class=""><?php echo $this->data["userResult"]["userTicketCount"] ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-5 justify-conter-right">
                            <img data-toggle="modal" width="100" height="100" data-target="#qrModal" src="<?php echo $this->data['qrCode'] ?>">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-8 border-left">
                            <div class="row">
                                <div class="col-12 text-right">
                                    نشانی : میدان بهارستان ، انتهای خیابان شریف رضی ، مجموعه فرهنگی رفاه
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="row">
                                <div class="col-12 mb-2 text-center">
                                        <h6 class="text-center">مسیریابی</h6>
                                    <div class="col-12 mb-2 text-center">
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-12 text-right px-0 mb-1 text-secondry">1 - هنگام ورود حتما بلیط را همراه خود داشته باشید</div>
                        <div class="col-12 text-right px-0 mb-1 text-secondry">2 - در هنگام اجرا از فیلمبرداری جدا خودداری بفرمایید</div>
                        <div class="col-12 text-right px-0 mb-1 text-secondry">3 - آوردن خوراکی به داخل سالن ممنوع است</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title text-right">بلیط ورود</h4>
                    <button type="button" class="close justify-self-end" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 text-center justify-content-center">
                        <img style="width:90%" src="<?php echo $this->data['qrCode'] ?>">
                        </div>
                    </div>
                </div>
            </div>
