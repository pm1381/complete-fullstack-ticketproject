...
<?php if ($this->data['error']) { ?>
   <div class="containter d-flex align-items-center" id="hero">
    <div class="row justify-content-center">
        <div class="col-10 pt-3">
            <div class="card" style="background-color:#d99600 !important">
                <div class="card-body justify-content-center d-flex align-items-center" style="height:200px">
                    <h3 class="text-center"><?php echo $this->data['errorMessgae']; ?></h3>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 text-center">
                                <h3 class="text-success">خرید بلیط با موفقیت انجام شد</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 text-center">
                            <svg width="45px" height="45px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 490.05 490.05" style="enable-background:new 0 0 490.05 490.05;" xml:space="preserve">
                            <path style="fill: #65c136;" d="M418.275,418.275c95.7-95.7,95.7-250.8,0-346.5s-250.8-95.7-346.5,0s-95.7,250.8,0,346.5S322.675,513.975,418.275,418.275    z M157.175,207.575l55.1,55.1l120.7-120.6l42.7,42.7l-120.6,120.6l-42.8,42.7l-42.7-42.7l-55.1-55.1L157.175,207.575z"/></svg>
                            </div>
                        </div>
                        <div class="row mt-3 justify-content-center">
                            <div class="col-12 mb-2">      
                                <?php if ($this->data['qrCode'] != '') { ?>
                                    <div class="qrCode">
